    ...
    <body>
                    ...
                    <div class="content-body">
                        <div class="row">
                                ...
                                <?php 
                                    if(isset($_POST['register'])) {
                                        if(preg_match('/[^a-zA-Z\s]/', $_POST['name'])) {
                                            ...
                                            alert('Invalid Mobile Number','danger');
                                        } else if(strlen($_POST['mobile']) != 10){
                                            alert('Mobile number must be of 10 digits','danger');
                                        } else if(!filter_var($_POST['email'],FILTER_VALIDATE_EMAIL)) {
                                            alert('Invalid Email Address','danger');
                                        } else if(User::exists('regno',$_POST['regno'])) {
                                ...
                                <form method="POST" id="user-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="exampleRadios1" female" name="gender" value="<?php echo (isset($_POST['gender']) && $_POST['gender'] == 'female') ? 'checked' : '' ;?> required />
                                            <label class="form-check-label" for="exampleRadios1">
                                               Female
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" id="exampleRadios2" value="male" name="gender" value="female" name="gender" <?php echo (isset($_POST['gender']) && $_POST['gender'] == 'male') ? 'checked' : '' ; ?> required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Mobile No." name="mobile" value="<?php echo isset($_POST['mobile']) ? $_POST['mobile'] : '' ;?>" />
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Reg. No." name="regno" value="<?php echo isset($_POST['regno']) ? $_POST['regno'] : '' ;?>" id="regno" required />
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="col-md-6 mt-4">
                                <?php
                                    $sql = "select * from users where role_id = '".$role['id']."' order by created_at LIMIT 10";
                                    $result = $mysqli->query($sql);
                                ?>
        ...
        <script>
            $('#user-form').submit(function(event){
                var date = $('#date').val();
                var regno = $('#regno').val();
                var password = date.replace(/-/gi,'') + regno.replace(/-/gi,'')
